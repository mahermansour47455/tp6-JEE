    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <table class="table table-striped">
                <tr>
                    <th>ID</th><th>nom</th><th>prix</th><th>Categorie</th><th colspan="2" style="text-align: center">Actions</th>
                </tr>
                <c:forEach items="${model.produits}" var="p">
                    <tr>
                        ...
                        <td>${p.nomProduit }</td>
                        <td>${p.prix }</td>
                        <td>${p.categorieByIdCategorie.nomCat }</td>
                        <td><a onclick="return confirm('Are you sure ?')" href="supprimer.do?id=${p.idProduit }">sup</a></td>
